    ...
    *,
    ...
    def _help(_args: list[str]) -> str:
        return (
            ...
            "/modecompare SYM [BARS] — backtest all 4 modes, rank by return\n"
            "/deparamopt SYM [BARS] [mode=MODE] — grid-search best min_score + min_confidence\n"
            "/memeportfolio — meme sandbox portfolio status (cash, positions, return)\n"
            "/memebuy SYM QTY [REASON] — buy in meme sandbox (MEME: prefix, 3%% per pos)\n"
            "/memesell SYM QTY [REASON] — sell in meme sandbox\n"
            "/memeclose SYM [REASON] — close entire meme sandbox position\n"
            "/memewatch — meme positions + current DE signal per position\n"
            "/memeautorun [SYM ...] — DE-driven auto-trade in meme sandbox\n"
